...
FIELD_ATTR glData0[64] = {
	...
	{Attr_UnUsed, Attr_fix, 0},					/* 15 -- Date, Settlement */
	...
	//{Attr_UnUsed, Attr_fix, 0},					/* 23 -- Card Sequence Number */
	...
	{Attr_n, Attr_var1, LEN_TRACK2},			/* 35 -- Track 2 Data */
	{Attr_n, Attr_var2, LEN_TRACK3},			/* 36 -- Track 3 Data */
	...
	{Attr_b, Attr_fix,  LEN_FIELD43},			/* 43 -- Card Acceptor Name/Location */
	//{Attr_b, Attr_var2,  LEN_FIELD43},			/* 43 -- Card Acceptor Name/Location */
	//{Attr_a, Attr_var1, LEN_ADD_RSP_DATA},		/* 44 -- Additional Response Data */
	{Attr_UnUsed, Attr_var1, 0},				/* 44 -- Additional Response Data */
	{Attr_UnUsed, Attr_fix, 0},					/* 45 -- Track 1 Data(not used) */
	{Attr_UnUsed, Attr_fix, 0},					/* 46 -- not used */
	{Attr_UnUsed, Attr_fix, 0},					/* 47 -- not used */
	{Attr_b, Attr_var2, LEN_FIELD48},			/* 48 -- Additional Data - Private */
	{Attr_n, Attr_fix,  LEN_CURRENCY_CODE},		/* 49 -- Currency Code, Transaction */
	{Attr_UnUsed, Attr_fix,  0},				/* 50 -- not used */
	{Attr_UnUsed, Attr_fix,  0},				/* 51 -- not used */
	{Attr_a, Attr_fix,  LEN_PIN_DATA},			/* 52 -- Personal Identification Number (PIN) Data */
	//	{Attr_n, Attr_fix,  LEN_SECURITY_INFO},			/* 53 -- Security Related Control Information */
	{Attr_UnUsed, Attr_fix,  0},				/* 53 -- Security Related Control Information */
	//	{Attr_a, Attr_var2, LEN_EXT_AMOUNT},			/* 54 -- Additional Amounts */	// max 20
	{Attr_UnUsed, Attr_var2, 0},				/* 54 -- Additional Amounts */	// max 20
	...
	//	{Attr_a, Attr_var2, LEN_EP_DATA},				/* 58 -- Reserved National */
	{Attr_UnUsed, Attr_var2, 0},				/* 58 -- Reserved National */
	{Attr_UnUsed, Attr_fix, 0},					/* 59 -- Reserved National */
	{Attr_b, Attr_var2, LEN_FIELD60},			/* 60 -- Reserved Private */	// max 13
	//{Attr_b, Attr_var2, LEN_ORIGINAL_MSG},		/* 61 -- Reserved Private */	// max 29
	{Attr_b, Attr_var2, LEN_FIELD61},			/* 61 -- Reserved Private */	// max 300
	{Attr_b, Attr_var2, LEN_FIELD62},			/* 62 -- Reserved Private */
	{Attr_b, Attr_var2, LEN_FIELD63},			/* 63 -- Reserved Private */	// max 163
